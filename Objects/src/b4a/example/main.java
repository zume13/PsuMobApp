...
vis = vis | (facilities.mostCurrent != null);
vis = vis | (map.mostCurrent != null);
vis = vis | (food.mostCurrent != null);
return vis;}
...
BA.applicationContext.stopService(new android.content.Intent(BA.applicationContext, starter.class));
 {
            Activity __a = null;
            if (facilities.previousOne != null) {
				__a = facilities.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(facilities.mostCurrent == null ? null : facilities.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (food.previousOne != null) {
				__a = food.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(food.mostCurrent == null ? null : food.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
...
public ResumableSub_GoToPage(b4a.example.main parent,Object _nextactivity) {
this.parent = parent;
...
RDebugUtils.currentLine=2490369;
 //BA.debugLineNum = 2490369;BA.debugLine="Dim pnlSlide As Panel";
_pnlslide = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=2490370;
 //BA.debugLineNum = 2490370;BA.debugLine="pnlSlide.Initialize(\"\")";
_pnlslide.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=2490372;
 //BA.debugLineNum = 2490372;BA.debugLine="Activity.AddView(pnlSlide, Activity.Width, 0, Act";
...
RDebugUtils.currentLine=2490373;
 //BA.debugLineNum = 2490373;BA.debugLine="pnlSlide.Color = Colors.RGB(142, 30, 44)";
_pnlslide.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (142),(int) (30),(int) (44)));
RDebugUtils.currentLine=2490375;
 //BA.debugLineNum = 2490375;BA.debugLine="pnlSlide.SetLayoutAnimated(300, 0, 0, Activity.Wi";
...
RDebugUtils.currentLine=2490377;
 //BA.debugLineNum = 2490377;BA.debugLine="Sleep(320)";
anywheresoftware.b4a.keywords.Common.Sleep(mostCurrent.activityBA,new anywheresoftware.b4a.shell.DebugResumableSub.DelegatableResumableSub(this, "main", "gotopage"),(int) (320));
this.state = 1;
return;
case 1:
//C
...
RDebugUtils.currentLine=2490378;
 //BA.debugLineNum = 2490378;BA.debugLine="StartActivity(NextActivity)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,_nextactivity);
RDebugUtils.currentLine=2490380;
 //BA.debugLineNum = 2490380;BA.debugLine="Activity.Finish";
...
RDebugUtils.currentModule="main";
if (Debug.shouldDelegate(mostCurrent.activityBA, "nextb_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "nextb_click", null));}
RDebugUtils.currentLine=327680;
 //BA.debugLineNum = 327680;BA.debugLine="Private Sub NextB_Click";
RDebugUtils.currentLine=327681;
 //BA.debugLineNum = 327681;BA.debugLine="GoToPage(Map)";
_gotopage((Object)(mostCurrent._map.getObject()));
